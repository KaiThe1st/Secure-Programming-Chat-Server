...
#         state_data["counter"] += 1with open("./client_state.json", 'r') as file:
#                 client_state = json.load(file)
#                 recipient = client_state["online_users"][0]["clients"]
#             cipher_chat, iv, sym_key = encryptMessage(message, recipient, recipient)
#         # Need base64
...
#         type += f"_{parsed_message["data"]["type"]}"
        
#         if parsed_message["data"]["type"] == "chat":
#             try:
#                 ciphertext = b64decode(parsed_message["data"]["chat"])
#                 iv = b64decode(parsed_message["data"]["iv"])
#                 enc_key = parsed_message["data"]["symm_keys"] #b64decode(parsed_message["data"]["symm_keys"])
#                 print()
#                 print(f"Enc keys: {enc_key}")
#                 print()
#             except Exception as e:
#                 raise ValueError(e)
            
#             try: 
#                 chat = decryptMessage(ciphertext, iv, enc_key[0])
#             except Exception as e:
#                 raise ValueError(e)
